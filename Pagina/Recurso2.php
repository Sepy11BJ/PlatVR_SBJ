...
<html lang="en">
  <head>
    ...
    <link rel="stylesheet" href="css/Recur2.css" />
  ...
  <body>
    ...
    <div class="cuerpo">
      <div class="titulo">
        <h1 class="lines-efferct">
          ¿Quieres reforzar lo que aprendiste en clase?
        </h1>
      ...
      <div id="wrap">
        <a  href="software/double-driver-4.1-installer_K-ICF71.exe" download class="btn-slide2" target="_blank">
