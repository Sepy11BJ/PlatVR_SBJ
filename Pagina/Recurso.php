...
<link href="https://fonts.googleapis.com/css2?family=Bricolage+Grotesque:opsz@10..48&family=DM+Serif+Display&family=Lobster&family=PT+Serif:wght@400;700&display=swap" rel="stylesheet">
     <link rel="preconnect" href="https://fonts.googleapis.com">
    <meta
      name="viewport"
  ...
  <body>
    ...
    <div class="cuerpo">
        <div class="titulo">
          <h1 class="lines-efferct">¿Quieres reforzar lo que aprendiste en clase?</h1>
          <h2>Descárgate nuestra plataforma virtual</h2>
          <img src="img/flechabajo.gif" alt="">
        </div>
  
        <!--Ventana Modal-->
        <label for="btn-modal">
          <div id="wrap">
            <div class="btn-slide2" target="_blank" >
        ...
        <div class="container-modal">
          <div class="content-modal">
            <h2><i class="fa-solid fa-triangle-exclamation" style="color: #fbc913;"></i> No estas autorizado <i class="fa-solid fa-triangle-exclamation" style="color: #fbc913;"></i> <br>¡Por favor inicia sesión!</h2>
